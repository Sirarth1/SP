    ...
    <div class="container">
        ...
        <form action="" class="">
            ...
            <div class="col-md-12">
                ...
                <div class="form-group col-md-3">
                    <label for="">Tiempó de uso</label><br>
                        <select class="form-control" name="" id="">
                            <option value="">menor a 1 año</option>
                            <option value="">de 1 a 3 años</option>
                            <option value="">de 3 a 6 años</option>
                            <option value="">mayor a 6 años</option>
                        </select>
                </div>
                <div class="form-group col-md-3">
